...
// Circles
#define PRIOR_COLOR  CLITERAL(Color){255, 51, 51, 210}
#define PRIOR_COLOR_LINES  CLITERAL(Color){255, 51, 51, 240}
...
#define CH_COLOR  CLITERAL(Color){40, 164, 40, 40}
#define CH2_COLOR  CLITERAL(Color){102, 102, 255, 40}
