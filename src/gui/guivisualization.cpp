...
GuiVisualization::GuiVisualization(){
    ...
    layoutRecsGroupBoxVisualization = (Rectangle){AnchorVisualization.x + 0, AnchorVisualization.y + 0, 655, 655};    // GroupBox: GroupBoxVisualization;
    ...
    layoutRecsPanelVisualization = (Rectangle){AnchorVisualization.x + 20, AnchorVisualization.y + 72, 615, 563};    // Panel: PanelVisualization;
}